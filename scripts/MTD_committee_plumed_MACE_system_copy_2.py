...
# === MACE Committee ===
mace_committee = MACECalculator(model_paths=args.model_paths, device='cuda', default_dtype='float64')
...
sorted_frames = [atoms for _, atoms in sorted(frames_with_variance, key=lambda x: x[0], reverse=True)]
