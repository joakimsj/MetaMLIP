...
include { runMACE; calcREF; updateDataset; reTrainMACE_recursive } from './processes.nf'
...
workflow ITERATION_STEP {
    ...
    main:
        ...
        // === Retraining step (3 jobs via each model) ===
        seed_ch = Channel.of(123)
        flattened_models_ch = models_ch.flatten()

        retrain_out = reTrainMACE_recursive(
            calcREF_out.new_data,
            flattened_models_ch,
            dataset_ch,
            seed_ch,
