...
process calcREF {
  ...
  publishDir "results/calcREF/${run_label}", mode: 'copy'
...
process updateDataset {
  ...
  publishDir "results/updateDataset/${run_label}", mode: 'copy'
...
process reTrainMACE {
  ...
  publishDir "results/reTrainMACE/${run_label}/seed_${seed}", mode: 'copy'
