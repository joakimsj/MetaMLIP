...
process runMACE {
  ...
  script:
    ...
    python ${descriptorFilter} --new frames_for_DFT_eval.xyz --reference ${growingDataset} --threshold 5 --max_structures 10
    echo "Filtering done!"
    """
}
...
process updateDataset {
  ...
  script:
    ...
    cp growing_dataset.xyz growing_retrain_dataset.xyz
    """
}
